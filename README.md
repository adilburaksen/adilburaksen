...
**Offensive**: Burp Suite Pro, Metasploit, BloodHound, CrackMapExec, Impacket, Rubeus, Responder
**SAST/SCA**: Fortify SSC, SonarQube, Coverity, Nexus IQ, Snyk
**DAST**: Burp Suite, Invicti, BrightSec, WebInspect
**DevSecOps**: Jenkins, GitLab CI, GitHub Actions, Docker, Kubernetes, Terraform
**Cloud**: AWS (GuardDuty, Security Hub, WAF, IAM, ECS/Fargate), Azure, GCP
**Languages**: Python, Bash, JavaScript/TypeScript, PowerShell, Java, C#, C/C++
